...
class Initializer {
    ...
    setupDownloadDirs() {
        const downloadRootDirectory = path_1.default.resolve(ConfigHandler_js_1.AppConfig.downloadRootDirectoryPath);
        ...
        if (ConfigHandler_js_1.AppConfig.saveMetadataJSON) {
            ...
            ConfigHandler_js_1.AppConfig.metadataDirectoryPath = metadataDir;
        }
        if (ConfigHandler_js_1.AppConfig.saveImages) {
            ...
            ConfigHandler_js_1.AppConfig.imageDirectoryPath = imagesDir;
        }
    }
    SetupCopyDirs() {
        if (ConfigHandler_js_1.AppConfig.copyDownloadsToOtherLocation.length > 0) {
            ConfigHandler_js_1.AppConfig.copyDownloadsToOtherLocation.forEach((copyConfig) => {
                ...
                if (ConfigHandler_js_1.AppConfig.saveImages) {
                    const imagesDir = path_1.default.join(copyConfig.directoryPath, "images");
                    if (!fs_1.default.existsSync(imagesDir)) {
                        fs_1.default.mkdirSync(imagesDir, { recursive: true });
                    }
                }
